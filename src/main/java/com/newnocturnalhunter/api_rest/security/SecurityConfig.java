    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception { // Método que configura la seguridad de la aplicación
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/partidas/{idPartida}").access(authorizationConfig.getPartidasIdManager())
                        ...
                        .requestMatchers(HttpMethod.GET, "/personajes/{idPersonaje}").access(authorizationConfig.getPersonajesIdManager())
                        .requestMatchers(HttpMethod.DELETE, "/personajes/{idPersonaje}").access(authorizationConfig.getPersonajesIdManager())
                        .requestMatchers(HttpMethod.PUT, "/personajes/{idPersonaje}").access(authorizationConfig.getPersonajesIdManager())
                        .requestMatchers(HttpMethod.POST, "/personajes/").hasRole("ADMIN")
                        // Enemigos Endpoints
                        .requestMatchers(HttpMethod.GET, "/enemigos/").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/enemigos/{idEnemigo}").access(authorizationConfig.getEnemigosIdManager())
                        .requestMatchers(HttpMethod.DELETE, "/enemigos/{idEnemigo}").access(authorizationConfig.getEnemigosIdManager())
                        .requestMatchers(HttpMethod.PUT, "/enemigos/{idEnemigo}").access(authorizationConfig.getEnemigosIdManager())
